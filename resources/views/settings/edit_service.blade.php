                               ...
                               <div class="col-sm-3">
                                <div class="form-group{{ $errors->has('walk_margin') ? ' has-error' : ''}}">
                                  <label>Walk In Sale Margin</label>
                                   <input type="text" class="form-control" class="text-success" data-required="true" id="walk_margin" name="walk_margin" value="{{ Request::old('walk_margin') ?: '' }}"  name="walk_margin">       
                              ...
                              <div class="col-sm-3">
                                ...
                                <span class="help-block">{{ $errors->first('special_margin') }}</span>
                                 @endif    
                                    ...
                                    <input type="text" name="myoldid" id="myoldid" value="{{ Request::old('myoldid') ?: '' }}">
