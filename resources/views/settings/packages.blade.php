            ...
            <aside>
              ...
              <section class="vbox">
                <header class="header bg-white b-b clearfix">
                  <div class="row m-t-sm">
                    ...
                    <a href="#" data-toggle="modal" class="btn btn-sm btn-default"><i class="fa fa-print"></i> Print List</a>
                     <span class="badge badge-info">Record(s) Found :  {{ $items->total() }} {{ str_plural('Packages', $items->total()) }}</span>
                    </div>
                ...
                <section class="scrollable wrapper w-f">
                  ...
                  <header class="panel-heading font-bold">Insurance Packages
                    ...
                    <section class="scrollable">
                      <div class="tab-content">
                        <div class="tab-pane active" id="individual">
                           <form  class="bootstrap-modal-form" method="post" action="/add-insurance-company" class="panel-body wrapper-lg">
