<p><section class="panel panel-default">
                      ...
                      <div class="form-group pull-in clearfix">
                          <div class="col-sm-6">
                            ...
                            <input type="text" rows="3" class="form-control" id="ward_number" name="ward_number" value="{{ Request::old('ward_number') ?: '' }}">   
                      ...
                      <footer class="panel-footer text-right bg-light lter">
                        <button type="submit" class="btn btn-success btn-s-xs">Add Ward</button>
                      </footer>
                    </section></p>