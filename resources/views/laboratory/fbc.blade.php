            ...
            <section class="scrollable">
              <section class="hbox stretch">
                ...
                <div class="tab-content">
                  ...
                  {{--         <tr>
                            <td>{{ ++$key }}</td>
                            <td><input name="test_name[]" id="test_name" value="{{ $fbc->type }}" class="btn btn-rounded btn-sm btn-default"></td>

                            @if($fbc->input == 'textbox')
                           ...
                           <td> <select id="test_result" name="test_result[]" value="" rows="3" tabindex="1" data-placeholder="Select here.." style="width:150px; text-align: center;">
                             ...
                             @endif   
                              <td><input  class="btn btn-rounded btn-sm btn-default"></td>
                          ...
                          <input type="hidden" name="test_name[]" id="test_name" value="{{ $fbc->type }}" >
                            <input type="text" class="form-control" value="" id="test_result" name="test_result[]"> 
                          </td>
                          <td>
                         <input type="text" class="form-control" readonly="true" name="test_range[]" id="test_range" value="{{ $fbc->range }}"> 
                          </td>
                        <td>
                         <input type="text" class="form-control" name="test_interpretation[]" id="test_interpretation" > 
