...
{{--                 <div>
                <a href="/book-appointment"  data-toggle="modal" class="btn btn-sm btn-info bootstrap-modal-form-open"> <i class="fa fa-plus"></i>  Create New Appointment </a>
                  ...
                  <div>
                <a href="#new-appointment-request"  data-toggle="modal" class="btn btn-sm btn-info bootstrap-modal-form-open"> <i class="fa fa-plus"></i> Quick Note </a>
                </div>

                 <div class="line"></div>
                <div class="line"></div>
                 <div>
                <a href="/event-list"  data-toggle="modal" class="btn btn-sm btn-default bootstrap-modal-form-open"> <i class="fa fa-file"></i>   All Nurse Notes</a>
                </div>
                {{-- <div class="line"></div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">New Nurse Handing Over Note</h4>
        </div>
                    ...
                    <section class="scrollable">
                      <div class="tab-content">
                        <div class="tab-pane active" id="individual">
                           <form  class="bootstrap-modal-form" method="post" action="/create-event-nurse" class="panel-body wrapper-lg">
                          @include('event/nurse_note')
