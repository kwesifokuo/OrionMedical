                  ...
                  <section class="vbox">
                    <header class="header bg-light bg-gradient">
                      <ul class="nav nav-tabs nav-white">
                        ...
                        <li class=""><a href="#review-plan" data-toggle="tab"><i class="fa fa-calendar text-default"></i> Antenatal Attendant Chart </a></li>
                     ...
                     <div class="tab-pane" id="review-discharge">
                      ...
                      <div class="col-sm-10">
                        ...
                        <div class="radio">
                          <label>
                            <input type="radio" name="optionsRadios" id="optionsRadios2" value="option2">
                            External Referral <a href="#referral-request" class="btn btn-info rounded" data-toggle="modal">Create Referral Letter</a>
                          </label>
                        </div>
                          ...
                          <div class="panel panel-default">
                            <div class="panel-body">
                              ...
                              <h5>
                                ...
                                @if($physical->pe_pelvic == '') @else <li> Pelvic <label class="badge bg-default"> {{$physical->pe_pelvic}}  </label></li> @endif

                                @if($physical->pe_ext_genitalia == '') @else <li> Ext Genitalia <label class="badge bg-default"> {{$physical->pe_ext_genitalia}}  </label></li> @endif

                                @if($physical->pe_vulva == '') @else <li> Vulva <label class="badge bg-default"> {{$physical->pe_vulva}}  </label></li> @endif

                                @if($physical->pe_vagina == '') @else <li> Vagina <label class="badge bg-default"> {{$physical->pe_vagina}}  </label></li> @endif

                                 @if($physical->pe_adnexa == '') @else <li> Adnexa <label class="badge bg-default"> {{$physical->pe_adnexa}}  </label></li> @endif

                                @if($physical->pe_psychological == '') @else <li> Psychological <label class="badge bg-default"> {{$physical->pe_psychological}}  </label></li> @endif

                                @if($physical->pe_cervix == '') @else <li> Cervix <label class="badge bg-default"> {{$physical->pe_cervix}}  </label></li> @endif

                                @if($physical->pe_uterus == '') @else <li> Uterus <label class="badge bg-default"> {{$physical->pe_uterus}}  </label></li> @endif
                  ...
                  <div class="panel panel-default">
                      ...
                      <div id="collapseThree" class="panel-collapse collapse">
                        ...
                        <select name="medical_history[]" id="medical_history" style="width:100%" multiple data-placeholder="PMHx"  >
                         ...
                         <option value="@foreach($myhistories as $val) {{ $val->medical_history }}@endforeach" selected > @foreach($myhistories as $val) {{ $val->medical_history }} @endforeach </option>
                        ...
                        <select name="family_history[]" id="family_history" style="width:100%" multiple data-placeholder="FMHx"  >
                          ...
                          <option value="@foreach($myhistories as $val) {{ $val->family_history }}@endforeach" selected > @foreach($myhistories as $val) {{ $val->family_history }}@endforeach </option>
                        ...
                        <option value="@foreach($myhistories as $val) {{ $val->social_history }}@endforeach" selected > @foreach($myhistories as $val) {{ $val->social_history }}@endforeach </option>
                        ...
                        <option value="@foreach($myhistories as $val) {{ $val->vaccinations_history }}@endforeach" selected > @foreach($myhistories as $val) {{ $val->vaccinations_history }}@endforeach </option>
                        ...
                        <option value="@foreach($myhistories as $val) {{ $val->drug_history }}@endforeach" selected > @foreach($myhistories as $val) {{ $val->drug_history }}@endforeach </option>
                        ...
                        <option value="@foreach($myhistories as $val) {{ $val->surgical_history }}@endforeach" selected > @foreach($myhistories as $val) {{ $val->surgical_history }}@endforeach </option>
                        ...
                        <option value="@foreach($myhistories as $val) {{ $val->reproductive_history }}@endforeach" selected > @foreach($myhistories as $val) {{ $val->reproductive_history }}@endforeach </option>
                        ...
                        <option value="@foreach($myhistories as $val) {{ $val->allergy }}@endforeach" selected > @foreach($myhistories as $val) {{ $val->allergy }}@endforeach </option>
                        ...
                        <option value="@foreach($myhistories as $val) {{ $val->hospitalization_history }}@endforeach" selected > @foreach($myhistories as $val) {{ $val->hospitalization_history }}@endforeach </option>
                         {{--  @foreach($medicationhx as $medicationhx)
                        <option  value="{{ $medicationhx->type }}">{{ $medicationhx->type }}</option>
                          @endforeach --}}
                            </select>    
                        ...
                        <select name="gravida[]" id="gravida" style="width:100%" multiple data-placeholder="Gravida"  >
                         <option value="@foreach($myhistories as $val) {{ $val->gravida }}@endforeach" selected > @foreach($myhistories as $val) {{ $val->gravida }}@endforeach </option>
                         {{--  @foreach($reproductivehx as $reproductivehx)
                        <option  value="{{ $reproductivehx->type }}">{{ $reproductivehx->type }}</option>
                          @endforeach --}}
                            </select>    
                        ...
                        <select name="parity[]" id="parity" style="width:100%" multiple data-placeholder="Para"  >
                         <option value="@foreach($myhistories as $val) {{ $val->parity }}@endforeach" selected > @foreach($myhistories as $val) {{ $val->parity }}@endforeach </option>
                         {{--  @foreach($allergichx as $allergichx)
                        <option  value="{{ $allergichx->type }}">{{ $allergichx->type }}</option>
                          @endforeach --}}
                            </select>    
                        ...
                        <option value="@foreach($myhistories as $val) {{ $val->living }}@endforeach" selected > @foreach($myhistories as $val) {{ $val->living }}@endforeach </option>
                         {{--  @foreach($allergichx as $allergichx)
                        <option  value="{{ $allergichx->type }}">{{ $allergichx->type }}</option>
                          @endforeach --}}
                            </select>    
                        ...
                        <option value="@foreach($myhistories as $val) {{ $val->developmental_history }}@endforeach" selected > @foreach($myhistories as $val) {{ $val->developmental_history }}@endforeach </option>
                         {{--  @foreach($medicationhx as $medicationhx)
                        <option  value="{{ $medicationhx->type }}">{{ $medicationhx->type }}</option>
                          @endforeach --}}
                            </select>    
                        ...
                        <option value="@foreach($myhistories as $val) {{ $val->obs_history }}@endforeach" selected > @foreach($myhistories as $val) {{ $val->obs_history }}@endforeach </option>
                         {{--  @foreach($surgicalhx as $surgicalhx)
                        <option  value="{{ $surgicalhx->type }}">{{ $surgicalhx->type }}</option>
                          @endforeach --}}
                            </select>    
                        ...
                        <select name="gynae_history[]" id="gynae_history" style="width:100%" multiple data-placeholder="Gynae Hx"  >
                         <option value="@foreach($myhistories as $val) {{ $val->gynae_history }}@endforeach" selected > @foreach($myhistories as $val) {{ $val->gynae_history }}@endforeach </option>
                         {{--  @foreach($reproductivehx as $reproductivehx)
                        <option  value="{{ $reproductivehx->type }}">{{ $reproductivehx->type }}</option>
                          @endforeach --}}
                            </select>    
                    ...
                    <div class="panel panel-default">
                      ...
                      <div id="collapseFive" class="panel-collapse collapse">
                        ...
                        <div class="tab-pane" id="review-vitals">
                      ...
                      <div id="collapseSix" class="panel-collapse collapse">
                        ...
                        <option  value="{{ $pe_neck->type }}">{{ $pe_neck->type }}</option>
                          @endforeach 
                            ...
                            <div class="col-sm-3">
                             <label class="badge bg-warning">Pelvic</label> 
                        <select name="pe_pelvic[]" id="pe_pelvic" style="width:100%" multiple data-placeholder=""  >
                        <option value="@foreach($mype as $val) {{ $val->pe_pelvic }}@endforeach" selected > @foreach($mype as $val) {{ $val->pe_pelvic }}@endforeach </option>
 ...
 <img src="/images/128639.svg" width="10%" align="right"> 
               ...
               <div class="tab-pane" id="review-referal">
                ...
                <div class="col-sm-12">
                        ...
                        <div id="myreferal" name="myreferal" class="form-control" style="overflow:scroll;height:300px;max-height:300px" contenteditable="true"> @foreach($myplan as $plan)
                                 <a>{!!$plan->assessment!!}</a>
                               @endforeach</div>
...
function loadAntenatal()
    {
       $.get('/get-antenatal-records',
          ...
          { 
            ...
            $.each(data, function (key, value) 
            {           
            $('#AntenatalTable tbody').append('<tr><td>'+ value['created_on'] +'</td><td>'+ value['gestation_by_date'] +'</td><td>'+ value['position'] +'</td><td>'+ value['presentation'] +'</td><td>'+ value['engagement'] +'</td><td>'+ value['fh_fm'] +'</td> <td>'+ value['lie'] +'</td><td>'+ value['fetus'] +'</td><td>'+ value['urine_sugar'] +'</td><td>'+ value['urine_protein'] +'</td><td>'+ value['edd'] +'</td><td>'+ value['bloodtype'] +'</td><td>'+ value['g6pd'] +'</td><td>'+ value['tt'] +'</td><td>'+ value['sp'] +'</td><td>'+ value['fetal_heart_tone'] +'</td><td>'+ value['remarks'] +'</td><td><a a href="#"><i onclick="removeAntenatalRecord('+value['id']+')" class="fa fa-trash-o"></i></a></td></tr>');
            });                                 
         },'json');      
    }
...
{
if($('#gestation_by_date').val()!= "" && $('#presentation').val()!="")
{
