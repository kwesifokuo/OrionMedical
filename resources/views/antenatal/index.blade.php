             ...
             <section class="panel panel-default">
                <div class="row m-l-none m-r-none bg-light lter">
                  <div class="col-sm-6 col-md-3 padder-v b-r b-light">
                   <img src="/images/387614.svg" width="15%">
                    <a class="clear" href="/ophthalmology"  data-toggle="modal" class="btn btn-sm btn-default bootstrap-modal-form-open">
                      <span class="h3 block m-t-xs"><strong>{{$waiting->count()}}</strong></span>
                      <small class="text-muted text-uc">Waiting Room</small>
                    </a>
                  </div>
                    <div class="col-sm-6 col-md-3 padder-v b-r b-light lt">
                    <img src="/images/283507.svg" width="15%">
                    </span>
                    <a class="clear" href="/ophthalmology-reviewed">
                    ...
                    <div class="col-sm-6 col-md-3 padder-v b-r b-light">
                   <img src="/images/185923.svg" width="15%">
                    <a class="clear" href="#">
                   ...
                   <div class="col-sm-6 col-md-3 padder-v b-r b-light lt">
                    <img src="/images/361498.svg" width="15%">
                    </span>
                          ...
                          <tr>
                            ...
                            <td>{{ $patient->created_on }}</td>
                             ...
                             <td>{{ $patient->visit_type }}</td>
                              ...
                              @if($patient->consultation_type=='ANTENATAL CONSULTATION')
                              ...
                              <td><a href="#" onclick="doDischarge('{{ $patient->id }}','{{ $patient->fullname }}')" class="btn btn-rounded btn-sm btn-gplus" id="edit" name="edit" data-toggle="modal" alt="edit"><i class="fa fa-archive" data-toggle="tooltip" data-placement="top" title="" data-original-title="Discharge"> </i> Discharge </a>
                            </td>
                            @endrole
