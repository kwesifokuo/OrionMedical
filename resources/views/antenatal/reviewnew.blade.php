                      ...
                      <div class="panel-body">
                         <div class="form-group pull-in clearfix">
                          <div class="col-sm-12">
                            ...
                            <div class="form-group{{ $errors->has('assessment') ? ' has-error' : ''}}">
                           <div id="continuation_sheet" name="continuation_sheet" class="form-control" style="overflow:scroll;height:500px;max-height:500px" contenteditable="true"> @foreach($continuation as $continuation)
                                 <a>{!!$continuation->content!!}</a>
                               @endforeach</div>   
    ...
    $.get('/add-continuation',
        {
          "opd_number": $('#opd_number').val(),
          "patient_id": $('#patient_id').val(),
          "continuation_sheet": $('#continuation_sheet').html()
