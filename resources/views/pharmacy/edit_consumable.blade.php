<section class="panel panel-default">
                   ...
                   {{--         <div class="col-sm-6">
                        ...
                        <option value="{{ $application->type }}">{{ $application->type }}</option>
                         ...
                         <div class="form-group pull-in clearfix">
                          <div class="col-sm-6">
                            ...
                            <input type="text" rows="3" data-required="true" class="form-control" id="stock" name="stock" value="{{ Request::old('stock') ?: '' }}">   
                           @if ($errors->has('stock'))
                      ...
                      <footer class="panel-footer text-right bg-light lter">
                        <button type="submit" class="btn btn-success btn-s-xs">Update Consumable</button>
