...
@section('content')
        <section id="content">
          ...
          <aside class="aside-md bg-white b-r" id="subNav">
              <div class="wrapper b-b header">Pharmacy Manager</div>
              <ul class="nav">
          ...
          <ul class="nav">
           <li class="b-b b-light"><a href="/pharmacy.dashboard"><i class="fa fa-chevron-right pull-right m-t-xs text-xs icon-muted"></i>Overview</a></li>
                <li class="b-b b-light"><a href="#"><i class="fa fa-chevron-right pull-right m-t-xs text-xs icon-muted"></i>Store Details</a></li>
                <li class="b-b b-light"><a href="#"><i class="fa fa-chevron-right pull-right m-t-xs text-xs icon-muted"></i>Drug List</a></li>
                <li class="b-b b-light"><a href="#"><i class="fa fa-chevron-right pull-right m-t-xs text-xs icon-muted"></i>Drug Category</a></li>
                <li class="b-b b-light"><a href="/drug-suppliers"><i class="fa fa-chevron-right pull-right m-t-xs text-xs icon-muted"></i>Suppliers</a></li>
                <li class="b-b b-light"><a href="#"><i class="fa fa-chevron-right pull-right m-t-xs text-xs icon-muted"></i>Audit</a></li>
                <li class="b-b b-light"><a href="/drugs-pending-approval"><i class="fa fa-chevron-right pull-right m-t-xs text-xs icon-muted"></i>Pending Approval</a></li>
                 <li class="b-b b-light"><a href="/requested-consumables"><i class="fa fa-chevron-right pull-right m-t-xs text-xs icon-muted"></i>Pending Requistions</a></li>
...
{{--                      <span class="badge badge-info">Record(s) Found :  {{ $items->total() }} {{ str_plural('Branch', $items->total()) }}</span> --}}
                ...
                <section class="scrollable wrapper w-f">
                  ...
                  <header class="panel-heading font-bold">Drug Category
