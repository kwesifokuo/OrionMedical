                  ...
                  <header class="panel-heading">
                    ...
                    <div class="table-responsive">
                        <header class="panel-heading font-bold">
                                 <a href="#new-damaged-drug" class="bootstrap-modal-form-open" data-toggle="modal"><span class="badge bg-info pull-right">+</span></a>
                                </header>
                      <table class="table table-striped m-b-none text-sm" width="100%">
                          <thead>
                          <tr>
                            <th>Date Transered </th>
                             <th>Medication</th>
                           <th>Quantity</th>
                            <th>Price</th>
                            <th>Cost</th>
                            <th>Recorded Transfer By</th>
                            <th>Comment</th>
                          </tr>
                        </thead>
                        <tbody>
                        @foreach($drugs as $drug )
                          <tr>
                            ...
                            <td>{{ $drug->created_on }}</td>
                            <td>{{ $drug->item_name }}</td>
                            <td>{{ $drug->stock_added }}</td>
                            <td>{{ $drug->unit_price }}</td>
                            <td>{{ $drug->stock_added *  $drug->unit_price }}</td>
