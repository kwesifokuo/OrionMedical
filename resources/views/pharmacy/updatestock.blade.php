<section class="panel panel-default">
                      ...
                      <div class="form-group pull-in clearfix">
                          <div class="col-sm-6">
                            ...
                            <input type="text" rows="3" class="form-control" readonly="true" id="drug_number" name="drug_number" value="{{ Request::old('drug_number') ?: '' }}">   
                          ...
                          <div class="form-group pull-in clearfix">
                           <div class="col-sm-6">
                            ...
                            <input type="text" rows="3" data-required="true" readonly="true" class="form-control" id="generic_name" name="generic_name" value="{{ Request::old('generic_name') ?: '' }}">       
                         ...
                         <div class="form-group pull-in clearfix">
                           <div class="col-sm-6">
                            ...
                            <select type="text" rows="3" data-required="true" readonly="true" style="width:100%" id="brand" name="brand" value="{{ Request::old('brand') ?: '' }}">
                          ...
                          <div class="form-group{{ $errors->has('classification') ? ' has-error' : ''}}">
                            ...
                            <select type="text" rows="3" data-required="true" readonly="true" style="width:100%" id="classification" name="classification" value="{{ Request::old('classification') ?: '' }}">
                         ...
                         <div class="col-sm-6">
                          <div class="form-group{{ $errors->has('drug_form') ? ' has-error' : ''}}">
                            <label>Unit</label>
                             ...
                             <select id="drug_form" name="drug_form" readonly data-required="true" rows="3" tabindex="1" data-placeholder="Select here.." style="width:100%">
                        ...
                        <option value="{{ $application->type }}">{{ $application->type }}</option>
                         ...
                         <div class="form-group pull-in clearfix">
                          ...
                          <div class="col-sm-6">
                            ...
                            <div class="form-group{{ $errors->has('new_stock') ? ' has-error' : ''}}">
                            <input type="text" rows="3" data-required="true"  class="form-control bg-primary" id="new_stock" name="new_stock" value="{{ Request::old('new_stock') ?: '' }}">   
                           @if ($errors->has('new_stock'))
                          <span class="help-block">{{ $errors->first('new_stock') }}</span>
                           @endif    
                          </div>
                          </div>
                        </div>
                         ...
                         <div class="col-sm-6">
                          <div class="form-group{{ $errors->has('pack_size') ? ' has-error' : ''}}">
                            <label>Pack Size</label>
                             <input type="text" class="form-control" readonly="true" class="text-success" id="pack_size"  value="{{ Request::old('pack_size') ?: '' }}"  name="pack_size">       
                      ...
                      <footer class="panel-footer text-right bg-light lter">
                        <button type="submit" class="btn btn-success btn-s-xs">Update Stock Level</button>
