          ...
          <section class="vbox">          
            <section class="scrollable padder">
              <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                ...
                <li class="active"> Dietian Station </li>
              </ul>
                      ...
                      <table class="table table-striped m-b-none text-sm" width="100%">
                        ...
                        @foreach( $patients as $patient )
                          <tr>
                             ...
                             <td>{{ $patient->created_on->format('H:i:s') }}</td>
                            ...
                            <td>{{ ucwords(strtolower($patient->name)) }}</td>
                             <td>{{ $patient->chief_complaint }}</td>
                              ...
                              <td><a href="/dental-review/{{ $patient->opd_number }}" onclick="getDetails('{{ $patient->id }}','{{ $patient->patient_id }}')" class="btn btn-rounded btn-sm btn-info" id="edit" name="edit" data-toggle="modal" alt="edit"><i class="fa fa-stethoscope" data-toggle="tooltip" data-placement="top" title="" data-original-title="Consult"> </i> Review </a></td>

                              @elseif($patient->consultation_type=='OPHTHALMOLOGY CONSULTATION')
                              <td><a href="/ophthalmology-review/{{ $patient->opd_number }}" onclick="getDetails('{{ $patient->id }}','{{ $patient->patient_id }}')" class="btn btn-rounded btn-sm btn-info" id="edit" name="edit" data-toggle="modal" alt="edit"><i class="fa fa-stethoscope" data-toggle="tooltip" data-placement="top" title="" data-original-title="Consult"> </i> Review </a></td>
                              
                              @elseif($patient->consultation_type=='ANTENATAL')
                              <td><a href="/antenatal-review/{{ $patient->opd_number }}" onclick="getDetails('{{ $patient->id }}','{{ $patient->patient_id }}')" class="btn btn-rounded btn-sm btn-info" id="edit" name="edit" data-toggle="modal" alt="edit"><i class="fa fa-stethoscope" data-toggle="tooltip" data-placement="top" title="" data-original-title="Consult"> </i> Review </a></td>
