                       ...
                       <br>
                        ...
                        <div>
                         ...
                         <h5>
                          ...
                          <img src="/images/139290.svg" width="100%"> 
                        </div>
                      </div>
                    </section>
                  </section>
                      ...
                      <div class="form-group pull-in clearfix">
                        ...
                        <option value="{{ $accounttype->type }}">{{ $accounttype->type }}</option>
                         ...
                         <div class="form-group pull-in clearfix">
                          <div class="col-sm-6">
                            ...
                            <select id="ipd_visit_type" name="ipd_visit_type" data-required="true" rows="3" tabindex="1" data-placeholder="Select here.." style="width:100%">
                        ...
                        <option value="Admission">Admission</option>
                         <option value="Detention">Detention</option>
                          ...
                          <div class="form-group{{ $errors->has('consultation_type') ? ' has-error' : ''}}">
                            ...
                            <select id="ipd_consultation_type" name="ipd_consultation_type" data-required="true" rows="3" tabindex="1" data-placeholder="Select here.." style="width:100%">
                        ...
                        <div class="form-group pull-in clearfix">
                          <div class="col-sm-6">
                            <div class="form-group{{ $errors->has('visit_type') ? ' has-error' : ''}}">
                            <label>Ward</label>
                            <select id="ipd_location" name="ipd_location" data-required="true" rows="3" tabindex="1" data-placeholder="Select here.." style="width:100%">
...
$('#ipd_consultation_type').select2();
$('#ipd_location').select2();
$('#ipd_visit_type').select2();
