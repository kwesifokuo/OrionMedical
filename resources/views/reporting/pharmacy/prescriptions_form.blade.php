...
<section id="content">
          <section class="vbox">          
            <section class="scrollable padder">
              ...
              <div class="col-lg-12">
                  <h2 class="font-thin">Report - Prescriptions and Dispensations</h2>
                </div>
              ...
              <div class="col-sm-12">
               <section class="panel panel-default">
                <header class="panel-heading font-bold">
                  Report - Prescriptions and Dispensations
                </header>
                <div class="panel-body">
                  <form id="claimsummary" class="form-horizontal" action="/rpt-patient-visit" method="get" >
