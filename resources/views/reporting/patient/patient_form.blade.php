              ...
              <div class="col-sm-12">
               <section class="panel panel-default">
                ...
                <div class="panel-body">
                  <form id="claimsummary" class="form-horizontal" action="/rpt-patient-list" method="get" >
                    <div class="form-group">
                      <label class="col-sm-2 control-label"> Date Create</label>
                      <div class="col-sm-10">
